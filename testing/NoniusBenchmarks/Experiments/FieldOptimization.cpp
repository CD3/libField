...
NONIUS_BENCHMARK("EXPERIMENT | Field element assignment | Trial 1 | operator(Collection)",
[](nonius::chronometer meter)
{
...
NONIUS_BENCHMARK("EXPERIMENT | Field element assignment | Trial 2 | operator(int,int,int)",
[](nonius::chronometer meter)
{
